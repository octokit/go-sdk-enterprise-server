...
// Get gets the status and details of maintenance mode on all available nodes. For more information, see "[Enabling and scheduling maintenance mode](https://docs.github.com/enterprise-server@3.12/admin/configuration/configuring-your-enterprise/enabling-and-scheduling-maintenance-mode)."
// returns a []GhesGetMaintenanceable when successful
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/enterprise-admin/manage-ghes#get-the-status-of-maintenance-mode
...
// Post sets or schedules the maintenance mode. For more information, see "[Enabling and scheduling maintenance mode](https://docs.github.com/enterprise-server@3.12/admin/configuration/configuring-your-enterprise/enabling-and-scheduling-maintenance-mode)."
// returns a []GhesSetMaintenanceResponseable when successful
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/enterprise-admin/manage-ghes#set-the-status-of-maintenance-mode
...
// ToGetRequestInformation gets the status and details of maintenance mode on all available nodes. For more information, see "[Enabling and scheduling maintenance mode](https://docs.github.com/enterprise-server@3.12/admin/configuration/configuring-your-enterprise/enabling-and-scheduling-maintenance-mode)."
...
// ToPostRequestInformation sets or schedules the maintenance mode. For more information, see "[Enabling and scheduling maintenance mode](https://docs.github.com/enterprise-server@3.12/admin/configuration/configuring-your-enterprise/enabling-and-scheduling-maintenance-mode)."
// returns a *RequestInformation when successful
