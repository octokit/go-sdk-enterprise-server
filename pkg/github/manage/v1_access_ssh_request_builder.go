...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/enterprise-admin/manage-ghes#delete-a-ssh-key
...
// Get gets the configured SSH keys on all available nodes. For more information, see "[Accessing the administrative shell (SSH)](https://docs.github.com/enterprise-server@3.12/admin/administering-your-instance/administering-your-instance-from-the-command-line/accessing-the-administrative-shell-ssh)."
// returns a []GhesGetSshable when successful
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/enterprise-admin/manage-ghes#get-the-configured-ssh-keys
...
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/enterprise-admin/manage-ghes#set-a-new-ssh-key
