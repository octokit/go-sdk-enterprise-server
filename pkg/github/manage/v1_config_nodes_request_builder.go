...
// Get get node metadata for all configured nodes in the current cluster. For more information, see "[About clustering](https://docs.github.com/enterprise-server@3.14/admin/enterprise-management/configuring-clustering/about-clustering)."
// returns a GhesConfigNodesable when successful
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.14/rest/enterprise-admin/manage-ghes#get-ghes-node-metadata-for-all-nodes
...
// ToGetRequestInformation get node metadata for all configured nodes in the current cluster. For more information, see "[About clustering](https://docs.github.com/enterprise-server@3.14/admin/enterprise-management/configuring-clustering/about-clustering)."
