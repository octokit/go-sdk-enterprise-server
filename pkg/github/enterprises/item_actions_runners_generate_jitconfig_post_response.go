...
type ItemActionsRunnersGenerateJitconfigPostResponse struct {
    ...
    runner ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.Runnerable
}
...
func (m *ItemActionsRunnersGenerateJitconfigPostResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["runner"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.CreateRunnerFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetRunner(val.(ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.Runnerable))
        }
        return nil
    }
    return res
...
type ItemActionsRunnersGenerateJitconfigPostResponseable interface {
    ...
    GetRunner()(ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.Runnerable)
    SetEncodedJitConfig(value *string)()
    SetRunner(value ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.Runnerable)()
}
