...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.13/rest/secret-scanning/secret-scanning#list-secret-scanning-alerts-for-an-enterprise
