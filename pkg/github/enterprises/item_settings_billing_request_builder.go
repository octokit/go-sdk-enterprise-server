...
// AdvancedSecurity the advancedSecurity property
...
func (m *ItemSettingsBillingRequestBuilder) AdvancedSecurity()(*ItemSettingsBillingAdvancedSecurityRequestBuilder) {
    return NewItemSettingsBillingAdvancedSecurityRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func NewItemSettingsBillingRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSettingsBillingRequestBuilder) {
    m := &ItemSettingsBillingRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/enterprises/{enterprise}/settings/billing", pathParameters),
    }
    return m
}
