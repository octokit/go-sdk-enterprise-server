...
// Get lists all the emojis available to use on GitHub Enterprise Server.
// returns a EmojisGetResponseable when successful
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.13/rest/emojis/emojis#get-emojis
...
// ToGetRequestInformation lists all the emojis available to use on GitHub Enterprise Server.
