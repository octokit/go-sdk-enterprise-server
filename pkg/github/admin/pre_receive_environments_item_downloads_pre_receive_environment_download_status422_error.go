...
type PreReceiveEnvironmentsItemDownloadsPreReceiveEnvironmentDownloadStatus422Error struct {
    ...
    // The errors property
    errors []PreReceiveEnvironmentsItemDownloadsPreReceiveEnvironmentDownloadStatus422Error_errorsable
...
func NewPreReceiveEnvironmentsItemDownloadsPreReceiveEnvironmentDownloadStatus422Error()(*PreReceiveEnvironmentsItemDownloadsPreReceiveEnvironmentDownloadStatus422Error) {
    m := &PreReceiveEnvironmentsItemDownloadsPreReceiveEnvironmentDownloadStatus422Error{
        ApiError: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewApiError(),
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreatePreReceiveEnvironmentsItemDownloadsPreReceiveEnvironmentDownloadStatus422ErrorFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreatePreReceiveEnvironmentsItemDownloadsPreReceiveEnvironmentDownloadStatus422ErrorFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewPreReceiveEnvironmentsItemDownloadsPreReceiveEnvironmentDownloadStatus422Error(), nil
}
...
// returns a []PreReceiveEnvironmentsItemDownloadsPreReceiveEnvironmentDownloadStatus422Error_errorsable when successful
...
func (m *PreReceiveEnvironmentsItemDownloadsPreReceiveEnvironmentDownloadStatus422Error) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["errors"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreatePreReceiveEnvironmentsItemDownloadsPreReceiveEnvironmentDownloadStatus422Error_errorsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]PreReceiveEnvironmentsItemDownloadsPreReceiveEnvironmentDownloadStatus422Error_errorsable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(PreReceiveEnvironmentsItemDownloadsPreReceiveEnvironmentDownloadStatus422Error_errorsable)
                }
            }
            m.SetErrors(res)
        }
...
type PreReceiveEnvironmentsItemDownloadsPreReceiveEnvironmentDownloadStatus422Errorable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetErrors()([]PreReceiveEnvironmentsItemDownloadsPreReceiveEnvironmentDownloadStatus422Error_errorsable)
    GetMessage()(*string)
    SetErrors(value []PreReceiveEnvironmentsItemDownloadsPreReceiveEnvironmentDownloadStatus422Error_errorsable)()
