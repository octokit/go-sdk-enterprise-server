...
type UsersItemAuthorizationsPostRequestBody struct {
    ...
    // A list of [scopes](https://docs.github.com/enterprise-server@3.14/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
    scopes []string
}
...
// GetScopes gets the scopes property value. A list of [scopes](https://docs.github.com/enterprise-server@3.14/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
...
// SetScopes sets the scopes property value. A list of [scopes](https://docs.github.com/enterprise-server@3.14/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).
