...
type HooksPostRequestBody struct {
    ...
    // The [events](https://docs.github.com/enterprise-server@3.12/webhooks/event-payloads) that trigger this webhook. A global webhook can be triggered by `user` and `organization` events. Default: `user` and `organization`.
    events []string
...
// GetEvents gets the events property value. The [events](https://docs.github.com/enterprise-server@3.12/webhooks/event-payloads) that trigger this webhook. A global webhook can be triggered by `user` and `organization` events. Default: `user` and `organization`.
