...
func NewPreReceiveHooksWithPre_receive_hook_ItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PreReceiveHooksWithPre_receive_hook_ItemRequestBuilder) {
    m := &PreReceiveHooksWithPre_receive_hook_ItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/admin/pre-receive-hooks/{pre_receive_hook_id}", pathParameters),
    }
    return m
}
...
func NewPreReceiveHooksWithPre_receive_hook_ItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*PreReceiveHooksWithPre_receive_hook_ItemRequestBuilder) {
    ...
    return NewPreReceiveHooksWithPre_receive_hook_ItemRequestBuilderInternal(urlParams, requestAdapter)
}
// Delete delete a pre-receive hook
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.11/rest/enterprise-admin/pre-receive-hooks#delete-a-pre-receive-hook
...
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.11/rest/enterprise-admin/pre-receive-hooks#get-a-pre-receive-hook
...
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.11/rest/enterprise-admin/pre-receive-hooks#update-a-pre-receive-hook
...
func (m *PreReceiveHooksWithPre_receive_hook_ItemRequestBuilder) WithUrl(rawUrl string)(*PreReceiveHooksWithPre_receive_hook_ItemRequestBuilder) {
    return NewPreReceiveHooksWithPre_receive_hook_ItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
