...
// ByOrganization_id gets an item from the github.com/octokit/go-sdk-enterprise-server/pkg/github.organizations.item collection
...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/orgs/orgs#list-organizations
func (m *OrganizationsRequestBuilder) Get(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[OrganizationsRequestBuilderGetQueryParameters])([]ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.OrganizationSimpleable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.CreateOrganizationSimpleFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
