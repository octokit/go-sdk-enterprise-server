...
type ItemHooksPostRequestBody struct {
    ...
    // Determines what [events](https://docs.github.com/enterprise-server@3.12/webhooks/event-payloads) the hook is triggered for. Set to `["*"]` to receive all possible events.
    events []string
...
// GetEvents gets the events property value. Determines what [events](https://docs.github.com/enterprise-server@3.12/webhooks/event-payloads) the hook is triggered for. Set to `["*"]` to receive all possible events.
...
// SetEvents sets the events property value. Determines what [events](https://docs.github.com/enterprise-server@3.12/webhooks/event-payloads) the hook is triggered for. Set to `["*"]` to receive all possible events.
