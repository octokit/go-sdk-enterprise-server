...
// ByDelivery_id gets an item from the github.com/octokit/go-sdk-enterprise-server/pkg/github.orgs.item.hooks.item.deliveries.item collection
...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/orgs/webhooks#list-deliveries-for-an-organization-webhook
