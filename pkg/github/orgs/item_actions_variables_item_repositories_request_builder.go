...
// ByRepository_id gets an item from the github.com/octokit/go-sdk-enterprise-server/pkg/github.orgs.item.actions.variables.item.repositories.item collection
...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/actions/variables#list-selected-repositories-for-an-organization-variable
...
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/actions/variables#set-selected-repositories-for-an-organization-variable
