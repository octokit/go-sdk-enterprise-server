...
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/actions/permissions#set-default-workflow-permissions-for-an-organization
