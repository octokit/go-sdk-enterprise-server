...
func NewRepository_invitationsWithInvitation_ItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*Repository_invitationsWithInvitation_ItemRequestBuilder) {
    m := &Repository_invitationsWithInvitation_ItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/user/repository_invitations/{invitation_id}", pathParameters),
    }
    return m
}
...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/collaborators/invitations#decline-a-repository-invitation
...
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/collaborators/invitations#accept-a-repository-invitation
...
func (m *Repository_invitationsWithInvitation_ItemRequestBuilder) WithUrl(rawUrl string)(*Repository_invitationsWithInvitation_ItemRequestBuilder) {
    return NewRepository_invitationsWithInvitation_ItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
