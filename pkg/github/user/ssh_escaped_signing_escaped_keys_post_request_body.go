...
type Ssh_signing_keysPostRequestBody struct {
    ...
    // The public SSH key to add to your GitHub account. For more information, see "[Checking for existing SSH keys](https://docs.github.com/enterprise-server@3.12/authentication/connecting-to-github-with-ssh/checking-for-existing-ssh-keys)."
    key *string
...
// GetKey gets the key property value. The public SSH key to add to your GitHub account. For more information, see "[Checking for existing SSH keys](https://docs.github.com/enterprise-server@3.12/authentication/connecting-to-github-with-ssh/checking-for-existing-ssh-keys)."
...
// SetKey sets the key property value. The public SSH key to add to your GitHub account. For more information, see "[Checking for existing SSH keys](https://docs.github.com/enterprise-server@3.12/authentication/connecting-to-github-with-ssh/checking-for-existing-ssh-keys)."
