...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.13/rest/apps/installations#list-app-installations-accessible-to-the-user-access-token
