...
// ByInstallation_id gets an item from the github.com/octokit/go-sdk-enterprise-server/pkg/github.user.installations.item collection
...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.11/rest/apps/installations#list-app-installations-accessible-to-the-user-access-token
