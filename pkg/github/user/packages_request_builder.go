...
import (
    ...
    idfe81f62bf34ae3347ccebafe6ad58dc6a612f663d209b1f2887e70ecb7726ff "github.com/octokit/go-sdk-enterprise-server/pkg/github/user/packages"
)
...
// ByPackage_type gets an item from the github.com/octokit/go-sdk-enterprise-server/pkg/github.user.packages.item collection
...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.14/rest/packages/packages#list-packages-for-the-authenticated-users-namespace
func (m *PackagesRequestBuilder) Get(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[PackagesRequestBuilderGetQueryParameters])([]ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.PackageEscapedable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.CreatePackageEscapedFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
