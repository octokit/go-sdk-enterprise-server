...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.10/rest/packages/packages#get-list-of-conflicting-packages-during-docker-migration-for-user
