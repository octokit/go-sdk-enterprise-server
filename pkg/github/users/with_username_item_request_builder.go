...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/users/users#get-a-user
...
// Site_admin the site_admin property
...
func (m *WithUsernameItemRequestBuilder) Site_admin()(*ItemSite_adminRequestBuilder) {
    return NewItemSite_adminRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func (m *WithUsernameItemRequestBuilder) Suspended()(*ItemSuspendedRequestBuilder) {
    return NewItemSuspendedRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
