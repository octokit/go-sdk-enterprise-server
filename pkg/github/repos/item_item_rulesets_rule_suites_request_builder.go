...
import (
    ...
    i1dcba757084762da6414fd6bdcf7a0f0e2890e19d4acdeb54d695816fa2e794b "github.com/octokit/go-sdk-enterprise-server/pkg/github/repos/item/item/rulesets/rulesuites"
)
...
type ItemItemRulesetsRuleSuitesRequestBuilderGetQueryParameters struct {
    ...
    Rule_suite_result *i1dcba757084762da6414fd6bdcf7a0f0e2890e19d4acdeb54d695816fa2e794b.GetRule_suite_resultQueryParameterType `uriparametername:"rule_suite_result"`
    ...
    Time_period *i1dcba757084762da6414fd6bdcf7a0f0e2890e19d4acdeb54d695816fa2e794b.GetTime_periodQueryParameterType `uriparametername:"time_period"`
}
// ByRule_suite_id gets an item from the github.com/octokit/go-sdk-enterprise-server/pkg/github.repos.item.item.rulesets.ruleSuites.item collection
...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.14/rest/repos/rule-suites#list-repository-rule-suites
func (m *ItemItemRulesetsRuleSuitesRequestBuilder) Get(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[ItemItemRulesetsRuleSuitesRequestBuilderGetQueryParameters])([]ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.RuleSuitesable, error) {
