...
type ItemItemHooksItemWithHook_PatchRequestBody struct {
    ...
    // Determines what [events](https://docs.github.com/enterprise-server@3.12/webhooks/event-payloads) the hook is triggered for. This replaces the entire array of events.
    events []string
...
// GetEvents gets the events property value. Determines what [events](https://docs.github.com/enterprise-server@3.12/webhooks/event-payloads) the hook is triggered for. This replaces the entire array of events.
// returns a []string when successful
...
func (m *ItemItemHooksItemWithHook_PatchRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["config"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.CreateWebhookConfigFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetConfig(val.(ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.WebhookConfigable))
        }
        return nil
    }
...
// SetEvents sets the events property value. Determines what [events](https://docs.github.com/enterprise-server@3.12/webhooks/event-payloads) the hook is triggered for. This replaces the entire array of events.
...
type ItemItemHooksItemWithHook_PatchRequestBodyable interface {
    ...
    GetActive()(*bool)
    GetAddEvents()([]string)
    GetConfig()(ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.WebhookConfigable)
    GetEvents()([]string)
    GetRemoveEvents()([]string)
    SetActive(value *bool)()
    SetAddEvents(value []string)()
    SetConfig(value ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.WebhookConfigable)()
