...
func CreateWithPathGetResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    ...
    if parseNode != nil {
        ...
        if mappingValueNode != nil {
            ...
            if mappingValue != nil {
                if ie967d16dae74a49b5e0e051225c5dac0d76e5e38f13dd1628028cbce108c25b6.EqualFold(*mappingValue, "file") {
                    result.SetContentFile(ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.NewContentFile())
                } else if ie967d16dae74a49b5e0e051225c5dac0d76e5e38f13dd1628028cbce108c25b6.EqualFold(*mappingValue, "submodule") {
                    result.SetContentSubmodule(ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.NewContentSubmodule())
                } else if ie967d16dae74a49b5e0e051225c5dac0d76e5e38f13dd1628028cbce108c25b6.EqualFold(*mappingValue, "symlink") {
                    result.SetContentSymlink(ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.NewContentSymlink())
                }
            }
        }
    }
...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/repos/contents#delete-a-file
...
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/repos/contents#get-repository-content
...
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/repos/contents#create-or-update-file-contents
