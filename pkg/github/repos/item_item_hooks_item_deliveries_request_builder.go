...
// ByDelivery_id gets an item from the github.com/octokit/go-sdk-enterprise-server/pkg/github.repos.item.item.hooks.item.deliveries.item collection
...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.13/rest/repos/webhooks#list-deliveries-for-a-repository-webhook
