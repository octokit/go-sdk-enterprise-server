...
type ItemItemBranchesItemProtectionRequired_pull_request_reviewsPatchRequestBody struct {
    ...
    // Blocks merging pull requests until [code owners](https://docs.github.com/enterprise-server@3.14/articles/about-code-owners/) have reviewed.
...
// GetRequireCodeOwnerReviews gets the require_code_owner_reviews property value. Blocks merging pull requests until [code owners](https://docs.github.com/enterprise-server@3.14/articles/about-code-owners/) have reviewed.
// returns a *bool when successful
...
// SetRequireCodeOwnerReviews sets the require_code_owner_reviews property value. Blocks merging pull requests until [code owners](https://docs.github.com/enterprise-server@3.14/articles/about-code-owners/) have reviewed.
