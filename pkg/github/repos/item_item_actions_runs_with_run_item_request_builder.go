...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.10/rest/actions/workflow-runs#delete-a-workflow-run
...
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.10/rest/actions/workflow-runs#get-a-workflow-run
