...
// ItemItemAssigneesRequestBuilderGetQueryParameters lists the [available assignees](https://docs.github.com/enterprise-server@3.14/articles/assigning-issues-and-pull-requests-to-other-github-users/) for issues in a repository.
...
// Get lists the [available assignees](https://docs.github.com/enterprise-server@3.14/articles/assigning-issues-and-pull-requests-to-other-github-users/) for issues in a repository.
// returns a []SimpleUserable when successful
// returns a BasicError error when the service returns a 404 status code
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.14/rest/issues/assignees#list-assignees
...
// ToGetRequestInformation lists the [available assignees](https://docs.github.com/enterprise-server@3.14/articles/assigning-issues-and-pull-requests-to-other-github-users/) for issues in a repository.
