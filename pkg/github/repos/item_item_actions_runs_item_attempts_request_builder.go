...
// ByAttempt_number gets an item from the github.com/octokit/go-sdk-enterprise-server/pkg/github.repos.item.item.actions.runs.item.attempts.item collection
