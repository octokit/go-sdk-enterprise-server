...
// Post this will trigger a [ping event](https://docs.github.com/enterprise-server@3.12/webhooks/#ping-event) to be sent to the hook.
// returns a BasicError error when the service returns a 404 status code
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/repos/webhooks#ping-a-repository-webhook
...
// ToPostRequestInformation this will trigger a [ping event](https://docs.github.com/enterprise-server@3.12/webhooks/#ping-event) to be sent to the hook.
