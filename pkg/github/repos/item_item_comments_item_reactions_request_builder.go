...
import (
    ...
    i2daa89030a4a9be72ff596adb42acdd38f379e1d583f9f68dea5e1f91d45ba3d "github.com/octokit/go-sdk-enterprise-server/pkg/github/repos/item/item/comments/item/reactions"
)
...
// ItemItemCommentsItemReactionsRequestBuilderGetQueryParameters list the reactions to a [commit comment](https://docs.github.com/enterprise-server@3.12/rest/commits/comments#get-a-commit-comment).
type ItemItemCommentsItemReactionsRequestBuilderGetQueryParameters struct {
    // Returns a single [reaction type](https://docs.github.com/enterprise-server@3.12/rest/reactions/reactions#about-reactions). Omit this parameter to list all reactions to a commit comment.
...
// Get list the reactions to a [commit comment](https://docs.github.com/enterprise-server@3.12/rest/commits/comments#get-a-commit-comment).
// returns a []Reactionable when successful
// returns a BasicError error when the service returns a 404 status code
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/reactions/reactions#list-reactions-for-a-commit-comment
...
// Post create a reaction to a [commit comment](https://docs.github.com/enterprise-server@3.12/rest/commits/comments#get-a-commit-comment). A response with an HTTP `200` status means that you already added the reaction type to this commit comment.
// returns a Reactionable when successful
// returns a ValidationError error when the service returns a 422 status code
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/reactions/reactions#create-reaction-for-a-commit-comment
...
// ToGetRequestInformation list the reactions to a [commit comment](https://docs.github.com/enterprise-server@3.12/rest/commits/comments#get-a-commit-comment).
...
// ToPostRequestInformation create a reaction to a [commit comment](https://docs.github.com/enterprise-server@3.12/rest/commits/comments#get-a-commit-comment). A response with an HTTP `200` status means that you already added the reaction type to this commit comment.
// returns a *RequestInformation when successful
