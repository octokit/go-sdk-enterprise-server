...
// ItemItemReleasesItemReactionsRequestBuilderGetQueryParameters list the reactions to a [release](https://docs.github.com/enterprise-server@3.11/rest/releases/releases#get-a-release).
type ItemItemReleasesItemReactionsRequestBuilderGetQueryParameters struct {
    // Returns a single [reaction type](https://docs.github.com/enterprise-server@3.11/rest/reactions/reactions#about-reactions). Omit this parameter to list all reactions to a release.
...
// Get list the reactions to a [release](https://docs.github.com/enterprise-server@3.11/rest/releases/releases#get-a-release).
// returns a []Reactionable when successful
// returns a BasicError error when the service returns a 404 status code
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.11/rest/reactions/reactions#list-reactions-for-a-release
...
// Post create a reaction to a [release](https://docs.github.com/enterprise-server@3.11/rest/releases/releases#get-a-release). A response with a `Status: 200 OK` means that you already added the reaction type to this release.
// returns a Reactionable when successful
// returns a ValidationError error when the service returns a 422 status code
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.11/rest/reactions/reactions#create-reaction-for-a-release
...
// ToGetRequestInformation list the reactions to a [release](https://docs.github.com/enterprise-server@3.11/rest/releases/releases#get-a-release).
...
// ToPostRequestInformation create a reaction to a [release](https://docs.github.com/enterprise-server@3.11/rest/releases/releases#get-a-release). A response with a `Status: 200 OK` means that you already added the reaction type to this release.
// returns a *RequestInformation when successful
