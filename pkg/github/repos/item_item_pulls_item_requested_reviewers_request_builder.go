...
func NewItemItemPullsItemRequested_reviewersRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemPullsItemRequested_reviewersRequestBuilder) {
    m := &ItemItemPullsItemRequested_reviewersRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/repos/{owner%2Did}/{repo%2Did}/pulls/{pull_number}/requested_reviewers", pathParameters),
    }
    return m
}
...
// Delete removes review requests from a pull request for a given set of users and/or teams.
// returns a PullRequestSimpleable when successful
// returns a ValidationError error when the service returns a 422 status code
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/pulls/review-requests#remove-requested-reviewers-from-a-pull-request
func (m *ItemItemPullsItemRequested_reviewersRequestBuilder) Delete(ctx context.Context, body ItemItemPullsItemRequested_reviewersDeleteRequestBodyable, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.DefaultQueryParameters])(ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.PullRequestSimpleable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.CreatePullRequestSimpleFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.PullRequestSimpleable), nil
}
// Get gets the users or teams whose review is requested for a pull request. Once a requested reviewer submits a review, they are no longer considered a requested reviewer. Their review will instead be returned by the [List reviews for a pull request](https://docs.github.com/enterprise-server@3.12/rest/pulls/reviews#list-reviews-for-a-pull-request) operation.
// returns a PullRequestReviewRequestable when successful
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/pulls/review-requests#get-all-requested-reviewers-for-a-pull-request
func (m *ItemItemPullsItemRequested_reviewersRequestBuilder) Get(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.DefaultQueryParameters])(ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.PullRequestReviewRequestable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.CreatePullRequestReviewRequestFromDiscriminatorValue, nil)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.PullRequestReviewRequestable), nil
}
...
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/pulls/review-requests#request-reviewers-for-a-pull-request
...
// ToDeleteRequestInformation removes review requests from a pull request for a given set of users and/or teams.
...
func (m *ItemItemPullsItemRequested_reviewersRequestBuilder) WithUrl(rawUrl string)(*ItemItemPullsItemRequested_reviewersRequestBuilder) {
    return NewItemItemPullsItemRequested_reviewersRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
