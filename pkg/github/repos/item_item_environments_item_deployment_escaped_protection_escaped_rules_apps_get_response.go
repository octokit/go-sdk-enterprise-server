...
type ItemItemEnvironmentsItemDeployment_protection_rulesAppsGetResponse struct {
    ...
    available_custom_deployment_protection_rule_integrations []ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.CustomDeploymentRuleAppable
...
func (m *ItemItemEnvironmentsItemDeployment_protection_rulesAppsGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["available_custom_deployment_protection_rule_integrations"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.CreateCustomDeploymentRuleAppFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.CustomDeploymentRuleAppable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.CustomDeploymentRuleAppable)
                }
            }
...
type ItemItemEnvironmentsItemDeployment_protection_rulesAppsGetResponseable interface {
    ...
    GetAvailableCustomDeploymentProtectionRuleIntegrations()([]ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.CustomDeploymentRuleAppable)
    GetTotalCount()(*int32)
    SetAvailableCustomDeploymentProtectionRuleIntegrations(value []ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.CustomDeploymentRuleAppable)()
