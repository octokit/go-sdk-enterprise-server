...
type ItemItemEnvironmentsItemWithEnvironment_namePutRequestBody_reviewers struct {
    ...
    typeEscaped *ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.DeploymentReviewerType
}
...
func (m *ItemItemEnvironmentsItemWithEnvironment_namePutRequestBody_reviewers) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["type"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.ParseDeploymentReviewerType)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetTypeEscaped(val.(*ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.DeploymentReviewerType))
        }
        return nil
    }
    return res
...
type ItemItemEnvironmentsItemWithEnvironment_namePutRequestBody_reviewersable interface {
    ...
    GetId()(*int32)
    GetTypeEscaped()(*ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.DeploymentReviewerType)
    SetId(value *int32)()
    SetTypeEscaped(value *ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.DeploymentReviewerType)()
}
