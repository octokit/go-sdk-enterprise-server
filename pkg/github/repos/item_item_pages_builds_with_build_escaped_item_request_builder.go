...
// Get gets information about a GitHub Enterprise Server Pages build.OAuth app tokens and personal access tokens (classic) need the `repo` scope to use this endpoint.
// returns a PageBuildable when successful
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.14/rest/pages/pages#get-apiname-pages-build
...
// ToGetRequestInformation gets information about a GitHub Enterprise Server Pages build.OAuth app tokens and personal access tokens (classic) need the `repo` scope to use this endpoint.
