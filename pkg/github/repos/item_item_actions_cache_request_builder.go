...
// UsagePolicy the usagePolicy property
...
func (m *ItemItemActionsCacheRequestBuilder) UsagePolicy()(*ItemItemActionsCacheUsagePolicyRequestBuilder) {
    return NewItemItemActionsCacheUsagePolicyRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
