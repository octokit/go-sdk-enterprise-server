...
// ItemItemIssuesCommentsItemReactionsRequestBuilderGetQueryParameters list the reactions to an [issue comment](https://docs.github.com/enterprise-server@3.11/rest/issues/comments#get-an-issue-comment).
type ItemItemIssuesCommentsItemReactionsRequestBuilderGetQueryParameters struct {
    // Returns a single [reaction type](https://docs.github.com/enterprise-server@3.11/rest/reactions/reactions#about-reactions). Omit this parameter to list all reactions to an issue comment.
...
// Get list the reactions to an [issue comment](https://docs.github.com/enterprise-server@3.11/rest/issues/comments#get-an-issue-comment).
// returns a []Reactionable when successful
// returns a BasicError error when the service returns a 404 status code
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.11/rest/reactions/reactions#list-reactions-for-an-issue-comment
...
// Post create a reaction to an [issue comment](https://docs.github.com/enterprise-server@3.11/rest/issues/comments#get-an-issue-comment). A response with an HTTP `200` status means that you already added the reaction type to this issue comment.
// returns a Reactionable when successful
// returns a ValidationError error when the service returns a 422 status code
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.11/rest/reactions/reactions#create-reaction-for-an-issue-comment
...
// ToGetRequestInformation list the reactions to an [issue comment](https://docs.github.com/enterprise-server@3.11/rest/issues/comments#get-an-issue-comment).
...
// ToPostRequestInformation create a reaction to an [issue comment](https://docs.github.com/enterprise-server@3.11/rest/issues/comments#get-an-issue-comment). A response with an HTTP `200` status means that you already added the reaction type to this issue comment.
// returns a *RequestInformation when successful
