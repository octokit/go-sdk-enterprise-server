...
func NewItemItemIssuesItemLockRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemItemIssuesItemLockRequestBuilder) {
    m := &ItemItemIssuesItemLockRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/repos/{owner%2Did}/{repo%2Did}/issues/{issue_number}/lock", pathParameters),
    }
    return m
}
...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.11/rest/issues/issues#unlock-an-issue
...
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.11/rest/issues/issues#lock-an-issue
...
func (m *ItemItemIssuesItemLockRequestBuilder) WithUrl(rawUrl string)(*ItemItemIssuesItemLockRequestBuilder) {
    return NewItemItemIssuesItemLockRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
