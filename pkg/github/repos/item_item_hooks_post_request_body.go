...
type ItemItemHooksPostRequestBody struct {
    ...
    // Determines what [events](https://docs.github.com/enterprise-server@3.11/webhooks/event-payloads) the hook is triggered for.
    events []string
...
// GetEvents gets the events property value. Determines what [events](https://docs.github.com/enterprise-server@3.11/webhooks/event-payloads) the hook is triggered for.
