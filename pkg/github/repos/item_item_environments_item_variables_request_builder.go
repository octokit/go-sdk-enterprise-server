...
// ByName gets an item from the github.com/octokit/go-sdk-enterprise-server/pkg/github.repos.item.item.environments.item.variables.item collection
...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/actions/variables#list-environment-variables
...
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/actions/variables#create-an-environment-variable
