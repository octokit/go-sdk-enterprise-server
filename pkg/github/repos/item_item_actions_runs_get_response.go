...
type ItemItemActionsRunsGetResponse struct {
    ...
    workflow_runs []ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.WorkflowRunable
}
...
func (m *ItemItemActionsRunsGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["workflow_runs"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.CreateWorkflowRunFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.WorkflowRunable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.WorkflowRunable)
                }
            }
...
type ItemItemActionsRunsGetResponseable interface {
    ...
    GetTotalCount()(*int32)
    GetWorkflowRuns()([]ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.WorkflowRunable)
    SetTotalCount(value *int32)()
    SetWorkflowRuns(value []ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.WorkflowRunable)()
}
