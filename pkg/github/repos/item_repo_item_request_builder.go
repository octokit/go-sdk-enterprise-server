...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.10/rest/repos/repos#delete-a-repository
...
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.10/rest/repos/repos#get-a-repository
...
func (m *ItemRepoItemRequestBuilder) Lfs()(*ItemItemLfsRequestBuilder) {
    return NewItemItemLfsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// Patch **Note**: To edit a repository's topics, use the [Replace all repository topics](https://docs.github.com/enterprise-server@3.10/rest/repos/repos#replace-all-repository-topics) endpoint.
// returns a FullRepositoryable when successful
// returns a BasicError error when the service returns a 403 status code
// returns a BasicError error when the service returns a 404 status code
...
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.10/rest/repos/repos#update-a-repository
...
func (m *ItemRepoItemRequestBuilder) PreReceiveHooks()(*ItemItemPreReceiveHooksRequestBuilder) {
    return NewItemItemPreReceiveHooksRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// returns a *ItemItemReplicasRequestBuilder when successful
func (m *ItemRepoItemRequestBuilder) Replicas()(*ItemItemReplicasRequestBuilder) {
    return NewItemItemReplicasRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
// ToPatchRequestInformation **Note**: To edit a repository's topics, use the [Replace all repository topics](https://docs.github.com/enterprise-server@3.10/rest/repos/repos#replace-all-repository-topics) endpoint.
// returns a *RequestInformation when successful
