...
// ByClient_id gets an item from the github.com/octokit/go-sdk-enterprise-server/pkg/github.applications.item collection
...
// Grants the grants property
// returns a *GrantsRequestBuilder when successful
func (m *ApplicationsRequestBuilder) Grants()(*GrantsRequestBuilder) {
    return NewGrantsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
