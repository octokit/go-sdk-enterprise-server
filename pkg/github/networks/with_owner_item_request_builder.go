...
// ByRepo gets an item from the github.com/octokit/go-sdk-enterprise-server/pkg/github.networks.item.item collection
// returns a *ItemWithRepoItemRequestBuilder when successful
...
func NewWithOwnerItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WithOwnerItemRequestBuilder) {
    m := &WithOwnerItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/networks/{owner}", pathParameters),
    }
    return m
}
