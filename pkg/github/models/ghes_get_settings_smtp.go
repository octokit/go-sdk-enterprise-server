...
type GhesGetSettings_smtp struct {
...
// NewGhesGetSettings_smtp instantiates a new GhesGetSettings_smtp and sets the default values.
func NewGhesGetSettings_smtp()(*GhesGetSettings_smtp) {
    m := &GhesGetSettings_smtp{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateGhesGetSettings_smtpFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateGhesGetSettings_smtpFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewGhesGetSettings_smtp(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *GhesGetSettings_smtp) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetAddress gets the address property value. The address property
// returns a *string when successful
func (m *GhesGetSettings_smtp) GetAddress()(*string) {
    return m.address
}
// GetAuthentication gets the authentication property value. The authentication property
// returns a *string when successful
func (m *GhesGetSettings_smtp) GetAuthentication()(*string) {
...
func (m *GhesGetSettings_smtp) GetDiscardToNoreplyAddress()(*bool) {
    return m.discardToNoreplyAddress
}
// GetDomain gets the domain property value. The domain property
// returns a *string when successful
func (m *GhesGetSettings_smtp) GetDomain()(*string) {
    return m.domain
}
// GetEnabled gets the enabled property value. The enabled property
// returns a *bool when successful
func (m *GhesGetSettings_smtp) GetEnabled()(*bool) {
    return m.enabled
}
// GetEnableStarttlsAuto gets the enable_starttls_auto property value. The enable_starttls_auto property
// returns a *bool when successful
func (m *GhesGetSettings_smtp) GetEnableStarttlsAuto()(*bool) {
    return m.enable_starttls_auto
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *GhesGetSettings_smtp) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *string when successful
func (m *GhesGetSettings_smtp) GetNoreplyAddress()(*string) {
    return m.noreply_address
}
// GetPassword gets the password property value. The password property
// returns a *string when successful
func (m *GhesGetSettings_smtp) GetPassword()(*string) {
    return m.password
}
// GetPort gets the port property value. The port property
// returns a *string when successful
func (m *GhesGetSettings_smtp) GetPort()(*string) {
    return m.port
}
// GetSupportAddress gets the support_address property value. The support_address property
// returns a *string when successful
func (m *GhesGetSettings_smtp) GetSupportAddress()(*string) {
...
// returns a *string when successful
func (m *GhesGetSettings_smtp) GetSupportAddressType()(*string) {
    return m.support_address_type
}
// GetUser_name gets the user_name property value. The user_name property
// returns a *string when successful
func (m *GhesGetSettings_smtp) GetUser_name()(*string) {
    return m.user_name
}
// GetUsername gets the username property value. The username property
// returns a *string when successful
func (m *GhesGetSettings_smtp) GetUsername()(*string) {
    return m.username
}
// Serialize serializes information the current object
func (m *GhesGetSettings_smtp) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *GhesGetSettings_smtp) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetAddress sets the address property value. The address property
func (m *GhesGetSettings_smtp) SetAddress(value *string)() {
    m.address = value
}
// SetAuthentication sets the authentication property value. The authentication property
func (m *GhesGetSettings_smtp) SetAuthentication(value *string)() {
...
func (m *GhesGetSettings_smtp) SetSupportAddressType(value *string)() {
    m.support_address_type = value
}
// SetUser_name sets the user_name property value. The user_name property
func (m *GhesGetSettings_smtp) SetUser_name(value *string)() {
    m.user_name = value
}
// SetUsername sets the username property value. The username property
func (m *GhesGetSettings_smtp) SetUsername(value *string)() {
    m.username = value
}
type GhesGetSettings_smtpable interface {
