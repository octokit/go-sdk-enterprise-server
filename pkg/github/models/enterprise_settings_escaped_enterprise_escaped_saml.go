...
type EnterpriseSettings_enterprise_saml struct {
...
// NewEnterpriseSettings_enterprise_saml instantiates a new EnterpriseSettings_enterprise_saml and sets the default values.
func NewEnterpriseSettings_enterprise_saml()(*EnterpriseSettings_enterprise_saml) {
    m := &EnterpriseSettings_enterprise_saml{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateEnterpriseSettings_enterprise_samlFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateEnterpriseSettings_enterprise_samlFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewEnterpriseSettings_enterprise_saml(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *EnterpriseSettings_enterprise_saml) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetCertificate gets the certificate property value. The certificate property
// returns a *string when successful
func (m *EnterpriseSettings_enterprise_saml) GetCertificate()(*string) {
    return m.certificate
}
// GetCertificatePath gets the certificate_path property value. The certificate_path property
// returns a *string when successful
func (m *EnterpriseSettings_enterprise_saml) GetCertificatePath()(*string) {
...
func (m *EnterpriseSettings_enterprise_saml) GetDisableAdminDemote()(*bool) {
    return m.disable_admin_demote
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *EnterpriseSettings_enterprise_saml) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *bool when successful
func (m *EnterpriseSettings_enterprise_saml) GetIdpInitiatedSso()(*bool) {
    return m.idp_initiated_sso
}
// GetIssuer gets the issuer property value. The issuer property
// returns a *string when successful
func (m *EnterpriseSettings_enterprise_saml) GetIssuer()(*string) {
    return m.issuer
}
// GetSsoUrl gets the sso_url property value. The sso_url property
// returns a *string when successful
func (m *EnterpriseSettings_enterprise_saml) GetSsoUrl()(*string) {
    return m.sso_url
}
// Serialize serializes information the current object
func (m *EnterpriseSettings_enterprise_saml) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *EnterpriseSettings_enterprise_saml) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetCertificate sets the certificate property value. The certificate property
func (m *EnterpriseSettings_enterprise_saml) SetCertificate(value *string)() {
    m.certificate = value
}
// SetCertificatePath sets the certificate_path property value. The certificate_path property
func (m *EnterpriseSettings_enterprise_saml) SetCertificatePath(value *string)() {
...
func (m *EnterpriseSettings_enterprise_saml) SetDisableAdminDemote(value *bool)() {
    m.disable_admin_demote = value
}
// SetIdpInitiatedSso sets the idp_initiated_sso property value. The idp_initiated_sso property
func (m *EnterpriseSettings_enterprise_saml) SetIdpInitiatedSso(value *bool)() {
    m.idp_initiated_sso = value
}
// SetIssuer sets the issuer property value. The issuer property
func (m *EnterpriseSettings_enterprise_saml) SetIssuer(value *string)() {
    m.issuer = value
}
// SetSsoUrl sets the sso_url property value. The sso_url property
func (m *EnterpriseSettings_enterprise_saml) SetSsoUrl(value *string)() {
    m.sso_url = value
}
type EnterpriseSettings_enterprise_samlable interface {
