...
// GetSelectedActionsUrl gets the selected_actions_url property value. The API URL to use to get or set the actions that are allowed to run, when `allowed_actions` is set to `selected`.
...
// SetSelectedActionsUrl sets the selected_actions_url property value. The API URL to use to get or set the actions that are allowed to run, when `allowed_actions` is set to `selected`.
