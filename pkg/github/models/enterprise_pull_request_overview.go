...
// NewEnterprisePullRequestOverview instantiates a new EnterprisePullRequestOverview and sets the default values.
func NewEnterprisePullRequestOverview()(*EnterprisePullRequestOverview) {
    m := &EnterprisePullRequestOverview{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateEnterprisePullRequestOverviewFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateEnterprisePullRequestOverviewFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewEnterprisePullRequestOverview(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *EnterprisePullRequestOverview) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *EnterprisePullRequestOverview) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *EnterprisePullRequestOverview) GetMergeablePulls()(*int32) {
    return m.mergeable_pulls
}
// GetMergedPulls gets the merged_pulls property value. The merged_pulls property
// returns a *int32 when successful
func (m *EnterprisePullRequestOverview) GetMergedPulls()(*int32) {
    return m.merged_pulls
}
// GetTotalPulls gets the total_pulls property value. The total_pulls property
// returns a *int32 when successful
func (m *EnterprisePullRequestOverview) GetTotalPulls()(*int32) {
    return m.total_pulls
}
// GetUnmergeablePulls gets the unmergeable_pulls property value. The unmergeable_pulls property
// returns a *int32 when successful
func (m *EnterprisePullRequestOverview) GetUnmergeablePulls()(*int32) {
    return m.unmergeable_pulls
}
// Serialize serializes information the current object
func (m *EnterprisePullRequestOverview) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
