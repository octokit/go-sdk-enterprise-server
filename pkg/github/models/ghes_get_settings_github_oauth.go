...
type GhesGetSettings_github_oauth struct {
...
// NewGhesGetSettings_github_oauth instantiates a new GhesGetSettings_github_oauth and sets the default values.
func NewGhesGetSettings_github_oauth()(*GhesGetSettings_github_oauth) {
    m := &GhesGetSettings_github_oauth{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateGhesGetSettings_github_oauthFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateGhesGetSettings_github_oauthFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewGhesGetSettings_github_oauth(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *GhesGetSettings_github_oauth) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetClientId gets the client_id property value. The client_id property
// returns a *string when successful
func (m *GhesGetSettings_github_oauth) GetClientId()(*string) {
    return m.client_id
}
// GetClientSecret gets the client_secret property value. The client_secret property
// returns a *string when successful
func (m *GhesGetSettings_github_oauth) GetClientSecret()(*string) {
    return m.client_secret
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *GhesGetSettings_github_oauth) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *string when successful
func (m *GhesGetSettings_github_oauth) GetOrganizationName()(*string) {
    return m.organization_name
}
// GetOrganizationTeam gets the organization_team property value. The organization_team property
// returns a *string when successful
func (m *GhesGetSettings_github_oauth) GetOrganizationTeam()(*string) {
    return m.organization_team
}
// Serialize serializes information the current object
func (m *GhesGetSettings_github_oauth) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
