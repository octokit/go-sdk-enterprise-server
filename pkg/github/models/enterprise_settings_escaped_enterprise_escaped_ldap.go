...
type EnterpriseSettings_enterprise_ldap struct {
    // Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additionalData map[string]any
    // The admin_group property
    admin_group *string
    // The base property
    base i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable
    ...
    profile EnterpriseSettings_enterprise_ldap_profileable
    // The reconciliation property
    reconciliation EnterpriseSettings_enterprise_ldap_reconciliationable
    ...
    user_groups i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable
...
// NewEnterpriseSettings_enterprise_ldap instantiates a new EnterpriseSettings_enterprise_ldap and sets the default values.
func NewEnterpriseSettings_enterprise_ldap()(*EnterpriseSettings_enterprise_ldap) {
    m := &EnterpriseSettings_enterprise_ldap{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateEnterpriseSettings_enterprise_ldapFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateEnterpriseSettings_enterprise_ldapFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewEnterpriseSettings_enterprise_ldap(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *EnterpriseSettings_enterprise_ldap) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetAdminGroup gets the admin_group property value. The admin_group property
// returns a *string when successful
func (m *EnterpriseSettings_enterprise_ldap) GetAdminGroup()(*string) {
    return m.admin_group
}
// GetBase gets the base property value. The base property
// returns a UntypedNodeable when successful
func (m *EnterpriseSettings_enterprise_ldap) GetBase()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
    return m.base
}
// GetBindDn gets the bind_dn property value. The bind_dn property
// returns a *string when successful
func (m *EnterpriseSettings_enterprise_ldap) GetBindDn()(*string) {
    return m.bind_dn
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *EnterpriseSettings_enterprise_ldap) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["base"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            m.SetBase(val.(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable))
        }
        return nil
    }
    ...
    res["profile"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateEnterpriseSettings_enterprise_ldap_profileFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetProfile(val.(EnterpriseSettings_enterprise_ldap_profileable))
        }
        return nil
    }
    res["reconciliation"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateEnterpriseSettings_enterprise_ldap_reconciliationFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetReconciliation(val.(EnterpriseSettings_enterprise_ldap_reconciliationable))
        }
        return nil
    }
    ...
    res["user_groups"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        ...
        if val != nil {
            m.SetUserGroups(val.(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable))
        }
        return nil
    }
...
// returns a *string when successful
func (m *EnterpriseSettings_enterprise_ldap) GetHost()(*string) {
    return m.host
}
// GetMethod gets the method property value. The method property
// returns a *string when successful
func (m *EnterpriseSettings_enterprise_ldap) GetMethod()(*string) {
    return m.method
}
// GetPassword gets the password property value. The password property
// returns a *string when successful
func (m *EnterpriseSettings_enterprise_ldap) GetPassword()(*string) {
    return m.password
}
// GetPort gets the port property value. The port property
// returns a *int32 when successful
func (m *EnterpriseSettings_enterprise_ldap) GetPort()(*int32) {
    return m.port
}
// GetPosixSupport gets the posix_support property value. The posix_support property
// returns a *bool when successful
func (m *EnterpriseSettings_enterprise_ldap) GetPosixSupport()(*bool) {
    return m.posix_support
}
// GetProfile gets the profile property value. The profile property
// returns a EnterpriseSettings_enterprise_ldap_profileable when successful
func (m *EnterpriseSettings_enterprise_ldap) GetProfile()(EnterpriseSettings_enterprise_ldap_profileable) {
    return m.profile
}
// GetReconciliation gets the reconciliation property value. The reconciliation property
// returns a EnterpriseSettings_enterprise_ldap_reconciliationable when successful
func (m *EnterpriseSettings_enterprise_ldap) GetReconciliation()(EnterpriseSettings_enterprise_ldap_reconciliationable) {
...
// returns a *bool when successful
func (m *EnterpriseSettings_enterprise_ldap) GetVirtualAttributeEnabled()(*bool) {
    return m.virtual_attribute_enabled
}
// Serialize serializes information the current object
func (m *EnterpriseSettings_enterprise_ldap) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
    ...
    {
        err := writer.WriteObjectValue("user_groups", m.GetUserGroups())
        if err != nil {
            return err
        }
    }
...
func (m *EnterpriseSettings_enterprise_ldap) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetAdminGroup sets the admin_group property value. The admin_group property
func (m *EnterpriseSettings_enterprise_ldap) SetAdminGroup(value *string)() {
    m.admin_group = value
}
// SetBase sets the base property value. The base property
func (m *EnterpriseSettings_enterprise_ldap) SetBase(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
    m.base = value
}
// SetBindDn sets the bind_dn property value. The bind_dn property
func (m *EnterpriseSettings_enterprise_ldap) SetBindDn(value *string)() {
    m.bind_dn = value
}
// SetHost sets the host property value. The host property
func (m *EnterpriseSettings_enterprise_ldap) SetHost(value *string)() {
    m.host = value
}
// SetMethod sets the method property value. The method property
func (m *EnterpriseSettings_enterprise_ldap) SetMethod(value *string)() {
    m.method = value
}
// SetPassword sets the password property value. The password property
func (m *EnterpriseSettings_enterprise_ldap) SetPassword(value *string)() {
    m.password = value
}
// SetPort sets the port property value. The port property
func (m *EnterpriseSettings_enterprise_ldap) SetPort(value *int32)() {
    m.port = value
}
// SetPosixSupport sets the posix_support property value. The posix_support property
func (m *EnterpriseSettings_enterprise_ldap) SetPosixSupport(value *bool)() {
    m.posix_support = value
}
// SetProfile sets the profile property value. The profile property
func (m *EnterpriseSettings_enterprise_ldap) SetProfile(value EnterpriseSettings_enterprise_ldap_profileable)() {
    m.profile = value
}
// SetReconciliation sets the reconciliation property value. The reconciliation property
func (m *EnterpriseSettings_enterprise_ldap) SetReconciliation(value EnterpriseSettings_enterprise_ldap_reconciliationable)() {
...
func (m *EnterpriseSettings_enterprise_ldap) SetVirtualAttributeEnabled(value *bool)() {
    m.virtual_attribute_enabled = value
}
type EnterpriseSettings_enterprise_ldapable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetAdminGroup()(*string)
    GetBase()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)
    GetBindDn()(*string)
    GetHost()(*string)
    GetMethod()(*string)
    GetPassword()(*string)
    ...
    GetProfile()(EnterpriseSettings_enterprise_ldap_profileable)
    GetReconciliation()(EnterpriseSettings_enterprise_ldap_reconciliationable)
    GetRecursiveGroupSearch()(*bool)
    GetSearchStrategy()(*string)
    GetSyncEnabled()(*bool)
    GetTeamSyncInterval()(*int32)
    GetUid()(*string)
    GetUserGroups()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)
    ...
    SetBase(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)()
    ...
    SetProfile(value EnterpriseSettings_enterprise_ldap_profileable)()
    SetReconciliation(value EnterpriseSettings_enterprise_ldap_reconciliationable)()
    SetRecursiveGroupSearch(value *bool)()
    SetSearchStrategy(value *string)()
    SetSyncEnabled(value *bool)()
    SetTeamSyncInterval(value *int32)()
    SetUid(value *string)()
    SetUserGroups(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)()
