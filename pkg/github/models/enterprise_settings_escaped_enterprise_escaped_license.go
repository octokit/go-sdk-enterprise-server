...
type EnterpriseSettings_enterprise_license struct {
...
// NewEnterpriseSettings_enterprise_license instantiates a new EnterpriseSettings_enterprise_license and sets the default values.
func NewEnterpriseSettings_enterprise_license()(*EnterpriseSettings_enterprise_license) {
    m := &EnterpriseSettings_enterprise_license{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateEnterpriseSettings_enterprise_licenseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateEnterpriseSettings_enterprise_licenseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewEnterpriseSettings_enterprise_license(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *EnterpriseSettings_enterprise_license) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetClusterSupport gets the cluster_support property value. The cluster_support property
// returns a *bool when successful
func (m *EnterpriseSettings_enterprise_license) GetClusterSupport()(*bool) {
    return m.cluster_support
}
// GetEvaluation gets the evaluation property value. The evaluation property
// returns a *bool when successful
func (m *EnterpriseSettings_enterprise_license) GetEvaluation()(*bool) {
    return m.evaluation
}
// GetExpireAt gets the expire_at property value. The expire_at property
// returns a *string when successful
func (m *EnterpriseSettings_enterprise_license) GetExpireAt()(*string) {
    return m.expire_at
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *EnterpriseSettings_enterprise_license) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *bool when successful
func (m *EnterpriseSettings_enterprise_license) GetPerpetual()(*bool) {
    return m.perpetual
}
// GetSeats gets the seats property value. The seats property
// returns a *int32 when successful
func (m *EnterpriseSettings_enterprise_license) GetSeats()(*int32) {
    return m.seats
}
// GetSshAllowed gets the ssh_allowed property value. The ssh_allowed property
// returns a *bool when successful
func (m *EnterpriseSettings_enterprise_license) GetSshAllowed()(*bool) {
    return m.ssh_allowed
}
// GetSupportKey gets the support_key property value. The support_key property
// returns a *string when successful
func (m *EnterpriseSettings_enterprise_license) GetSupportKey()(*string) {
    return m.support_key
}
// GetUnlimitedSeating gets the unlimited_seating property value. The unlimited_seating property
// returns a *bool when successful
func (m *EnterpriseSettings_enterprise_license) GetUnlimitedSeating()(*bool) {
    return m.unlimited_seating
}
// Serialize serializes information the current object
func (m *EnterpriseSettings_enterprise_license) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *EnterpriseSettings_enterprise_license) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetClusterSupport sets the cluster_support property value. The cluster_support property
func (m *EnterpriseSettings_enterprise_license) SetClusterSupport(value *bool)() {
    m.cluster_support = value
}
// SetEvaluation sets the evaluation property value. The evaluation property
func (m *EnterpriseSettings_enterprise_license) SetEvaluation(value *bool)() {
    m.evaluation = value
}
// SetExpireAt sets the expire_at property value. The expire_at property
func (m *EnterpriseSettings_enterprise_license) SetExpireAt(value *string)() {
    m.expire_at = value
}
// SetPerpetual sets the perpetual property value. The perpetual property
func (m *EnterpriseSettings_enterprise_license) SetPerpetual(value *bool)() {
    m.perpetual = value
}
// SetSeats sets the seats property value. The seats property
func (m *EnterpriseSettings_enterprise_license) SetSeats(value *int32)() {
    m.seats = value
}
// SetSshAllowed sets the ssh_allowed property value. The ssh_allowed property
func (m *EnterpriseSettings_enterprise_license) SetSshAllowed(value *bool)() {
    m.ssh_allowed = value
}
// SetSupportKey sets the support_key property value. The support_key property
func (m *EnterpriseSettings_enterprise_license) SetSupportKey(value *string)() {
    m.support_key = value
}
// SetUnlimitedSeating sets the unlimited_seating property value. The unlimited_seating property
func (m *EnterpriseSettings_enterprise_license) SetUnlimitedSeating(value *bool)() {
    m.unlimited_seating = value
}
type EnterpriseSettings_enterprise_licenseable interface {
