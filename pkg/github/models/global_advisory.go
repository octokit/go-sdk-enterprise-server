...
// GetCredits gets the credits property value. In GitHub Enterprise Server, this field will always be empty because the user metadata of credited users will not be available.
...
// SetCredits sets the credits property value. In GitHub Enterprise Server, this field will always be empty because the user metadata of credited users will not be available.
