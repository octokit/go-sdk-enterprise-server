...
import (
    ...
    i3a5de3f5f2a51975580fc1f7663601261dc5a6ac1f8616e88fbcdbb5ac387377 "github.com/octokit/go-sdk-enterprise-server/pkg/github/search/commits"
)
...
type CommitsRequestBuilderGetQueryParameters struct {
    ...
    // The query contains one or more search keywords and qualifiers. Qualifiers allow you to limit your search to specific areas of GitHub Enterprise Server. The REST API supports the same qualifiers as the web interface for GitHub Enterprise Server. To learn more about the format of the query, see [Constructing a search query](https://docs.github.com/enterprise-server@3.12/rest/search/search#constructing-a-search-query). See "[Searching commits](https://docs.github.com/enterprise-server@3.12/search-github/searching-on-github/searching-commits)" for a detailed list of qualifiers.
    Q *string `uriparametername:"q"`
    // Sorts the results of your query by `author-date` or `committer-date`. Default: [best match](https://docs.github.com/enterprise-server@3.12/rest/search/search#ranking-search-results)
    Sort *i3a5de3f5f2a51975580fc1f7663601261dc5a6ac1f8616e88fbcdbb5ac387377.GetSortQueryParameterType `uriparametername:"sort"`
}
...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/search/search#search-commits
