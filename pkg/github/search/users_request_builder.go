...
type UsersRequestBuilderGetQueryParameters struct {
    ...
    // Sorts the results of your query by number of `followers` or `repositories`, or when the person `joined` GitHub Enterprise Server. Default: [best match](https://docs.github.com/enterprise-server@3.10/rest/search/search#ranking-search-results)
...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.10/rest/search/search#search-users
