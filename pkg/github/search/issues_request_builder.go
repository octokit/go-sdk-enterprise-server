...
import (
    ...
    iaff4441ad75fc7bc6037e7836ce0e101f06cf4c04ad20d0918be9fe81c36145f "github.com/octokit/go-sdk-enterprise-server/pkg/github/search/issues"
)
...
type IssuesRequestBuilderGetQueryParameters struct {
    ...
    // The query contains one or more search keywords and qualifiers. Qualifiers allow you to limit your search to specific areas of GitHub Enterprise Server. The REST API supports the same qualifiers as the web interface for GitHub Enterprise Server. To learn more about the format of the query, see [Constructing a search query](https://docs.github.com/enterprise-server@3.12/rest/search/search#constructing-a-search-query). See "[Searching issues and pull requests](https://docs.github.com/enterprise-server@3.12/search-github/searching-on-github/searching-issues-and-pull-requests)" for a detailed list of qualifiers.
    Q *string `uriparametername:"q"`
    // Sorts the results of your query by the number of `comments`, `reactions`, `reactions-+1`, `reactions--1`, `reactions-smile`, `reactions-thinking_face`, `reactions-heart`, `reactions-tada`, or `interactions`. You can also sort results by how recently the items were `created` or `updated`, Default: [best match](https://docs.github.com/enterprise-server@3.12/rest/search/search#ranking-search-results)
    Sort *iaff4441ad75fc7bc6037e7836ce0e101f06cf4c04ad20d0918be9fe81c36145f.GetSortQueryParameterType `uriparametername:"sort"`
}
...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.12/rest/search/search#search-issues-and-pull-requests
func (m *IssuesRequestBuilder) Get(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[IssuesRequestBuilderGetQueryParameters])(IssuesGetResponseable, error) {
    ...
    errorMapping := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ErrorMappings {
        ...
        "503": ie1e2072a5a4eb80f74a1387d59644d3f70804e6b7b2f406016da8826571f1207.CreateIssues503ErrorFromDiscriminatorValue,
    }
