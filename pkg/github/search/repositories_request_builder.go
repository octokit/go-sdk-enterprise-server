...
type RepositoriesRequestBuilderGetQueryParameters struct {
    ...
    // Sorts the results of your query by number of `stars`, `forks`, or `help-wanted-issues` or how recently the items were `updated`. Default: [best match](https://docs.github.com/enterprise-server@3.10/rest/search/search#ranking-search-results)
...
// 
// [API method documentation]: https://docs.github.com/enterprise-server@3.10/rest/search/search#search-repositories
